...
window.VOCAB_DATA = {
  ...
  */
  words: [
    ...
    { word: "reinforcement", part: "n.",      meaning: "강화",                           example: "The part of the brain responsible for feelings of reinforcement and reward lit up." },
    ...
    { word: "redeem",        part: "v.",      meaning: "(명예 등을) 회복하다, 만회하다", example: "I felt I was a “taker” who could never redeem myself." },
    ...
    { word: "reciprocity",   part: "n.",      meaning: "상호성, 호혜",                   example: "They signal that one personally holds pro-social values like fairness and reciprocity." },
    { word: "indoctrinate",  part: "v.",      meaning: "(사상을) 주입하다",              example: "Dr. Pangloss indoctrinates the naive youth Candide in the philosophy that reality is the “best of all possible worlds.”" },
    ...
    { word: "ubiquitous",    part: "adj.",    meaning: "어디에나 있는, 아주 흔한",       example: "Eventually this system of denial becomes so ubiquitous that it becomes normalized." },
    ...
    { word: "corrupt",       part: "v./adj.", meaning: "타락시키다; 타락한",             example: "And when social norms are corrupted in this way, they mislead everyone." },
    { word: "bigotry",       part: "n.",      meaning: "편견, 편협함",                   example: "It leads to racism, sexism, and other forms of bigotry." },
    { word: "vigilant",      part: "adj.",    meaning: "경계하는, 방심하지 않는",        example: "We must not ignore them but instead be vigilant about them." },
    ...
    { word: "complicit",     part: "adj.",    meaning: "공모한, 연루된",                 example: "We are often complicit with norms without thinking, and so we make a fundamental mistake." },
    ...
    { word: "foment",        part: "v.",      meaning: "(갈등 등을) 조장하다, 부추기다", example: "They foment distrust in government institutions." },
    { word: "fringe",        part: "adj./n.", meaning: "주변부의; 비주류",               example: "It allows fringe actors to manufacture illusions by creating the impression of majorities that don’t exist in reality." },
